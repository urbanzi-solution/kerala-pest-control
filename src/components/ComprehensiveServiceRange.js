    ...
    <section className="bg-[#f5f7f2] py-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-[14px] leading-relaxed max-w-xl mx-auto">
            Kerala Pest Solutions provides the full range of pest management services to properties
            in Pattom. Every service is delivered to the same standard as our Trivandrum-wide
            operations, with written reports, CIB&RC-approved formulations, and IPM-trained
            technicians.
          </p>
        </div>
