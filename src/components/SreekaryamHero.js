          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-wrap items-center gap-5 mt-2">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-[#3670e3] hover:bg-[#3b7cff] text-white font-bold text-[14px] px-7 py-4 rounded-xl transition-colors duration-200"
              >
