const areas = [
  ["Kattakada", "Venjaramoodu", "Balaramapuram"],
  ["Kalliyoor","Attingal Road",],
 
];

export default function NemomCoverage() {
  return (
    <section className="bg-[#f1f3f2] py-14 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">

        {/* Left */}
        <div className="flex flex-col gap-4">
          <h2 className="text-2xl lg:text-3xl font-extrabold text-black leading-tight">
            Comprehensive Coverage Across<br/>the Nemom Corridor
          </h2>
          <p className="text-slate-500 text-[14px] leading-relaxed max-w-md">
            Our specialized mobile units are strategically stationed across the Nemom
