...
export default function ParavurHero() {
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <h1 className="text-4xl lg:text-5xl font-extrabold text-black leading-tight tracking-tight">
              Pest Control<br />Paravur
            </h1>

            {/* Body */}
            <p className="text-slate-600 text-[15px] leading-relaxed">
            Paravur (Kollam Paravur) is a town and municipality in Kollam district, situated at the northern end of Ashtamudi Lake — one of Kerala’s largest and most ecologically significant backwater systems. The town has a large fishing community, a significant commercial centre, and residential areas that span from the lakeshore to the inland eastern areas. The proximity to Ashtamudi Lake defines Paravur’s pest environment. Kerala Pest Solutions provides professional pest management across Paravur and the surrounding areas of Kollam district, with the same IPM standards, CIB&RC-registered formulations, and written service documentation that we apply across all our operations.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-5 mt-2">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-[#346cdb] hover:bg-[#3b7cff] text-white font-bold text-[14px] px-7 py-4 rounded-xl transition-colors duration-200"
              >
