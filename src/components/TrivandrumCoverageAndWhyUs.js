const areas = [
  [
    { name: "Kazhakoottam", href: "/trivandrum/kazhakoottam" },
    { name: "Technopark", href: "/trivandrum/technopark" },
  ],
  [
    { name: "Pattom", href: "/trivandrum/pattom" },
    { name: "Kowdiar", href: "/trivandrum/kowdiar" },
  ],
  [
    { name: "Sreekaryam", href: "/trivandrum/sreekaryam" },
    { name: "Karyavattom", href: "/trivandrum/karyavattom" },
  ],
  [
    { name: "Nalanchira", href: "/trivandrum/nalanchira" },
    { name: "Nemom", href: "/trivandrum/nemom" },
  ],
];
...
export default function TrivandrumCoverageAndWhyUs() {
  return (
    <div>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div>
            <h2 className="text-2xl lg:text-3xl font-extrabold text-emerald-900 leading-tight mb-8">
              Service Coverage in<br />Thiruvananthapuram
            </h2>
            ...
            <p className="text-slate-400 text-[12px] italic">
              Extended coverage: Vattiyoorkavu and Pangappara outskirts included.
            </p>
          </div>
