    ...
    <section className="bg-[#f0f2f0] py-20 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
        ...
        <div className="flex flex-col gap-7">
          <div>
            <h2 className="text-3xl lg:text-4xl font-extrabold text-emerald-900 leading-tight mb-3">
        ...
        {/* Right */}
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 flex flex-col gap-8 mt-19">
