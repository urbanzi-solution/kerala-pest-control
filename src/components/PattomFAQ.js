...
const faqs = [
  {
    question: "Do you offer same-day pest control in Pattom?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. We work with individual flat owners, building management committees, and housing society secretaries in Pattom. For mosquito control and rodent management, building-wide contracts are more effective and more cost-effective than individual unit treatments.",
  },
  {
  ...
  {
    question: "How do I book pest control in Pattom?",
    answer:
...
export default function PattomFAQ() {
    ...
    <section className="bg-white py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="text-3xl lg:text-4xl font-extrabold text-white text-center mb-12">
          Frequently Asked Questions — Pest Control in Pattom
        </h2>
