export default function KundaraChallenges() {
  return (
        ...
        <div className="flex flex-col gap-6">
          <div>
            <h2 className="text-2xl lg:text-3xl font-extrabold text-emerald-900 mb-3">
              Pest Challenges Specific to Kundara
            </h2>
            <div className="w-10 h-1 bg-amber-800 rounded-full" />
          </div>

          <p className="text-slate-600 text-[14px] leading-relaxed">
         Kundara’s position on the Kallada River creates mosquito breeding pressure along the riverbank and in the floodplain areas that surround parts of the town. The inland laterite soil is highly favourable to subterranean termite colonies, and the town’s older residential properties carry accumulated termite vulnerability. The town’s commercial activity and food businesses create cockroach and rodent pressure in the central areas.
