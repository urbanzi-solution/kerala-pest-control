export default function ParavurChallenges() {
  return (
        ...
        <div className="flex flex-col gap-6">
          <div>
            <h2 className="text-2xl lg:text-3xl font-extrabold text-emerald-900 mb-3">
              Pest Challenges Specific to Paravur
            </h2>
            <div className="w-10 h-1 bg-amber-800 rounded-full" />
          </div>

          <p className="text-slate-600 text-[14px] leading-relaxed">
         Paravur’s position on Ashtamudi Lake creates exceptional mosquito breeding conditions year-round, with dengue risk elevated during both monsoon seasons. The town’s fishing community infrastructure and fish processing activity attract rodents to the waterfront areas and adjacent residential streets. The high humidity characteristic of lakeshore environments accelerates termite activity and structural pest pressure across the town’s residential properties.
          </p>
        </div>
