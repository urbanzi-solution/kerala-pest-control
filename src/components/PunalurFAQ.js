...
const faqs = [
  {
    question: "Do you offer same-day pest control in Punalur?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. We serve individual flat owners and building management committees in Punalur. Building-wide contracts for mosquito and rodent management are available and more effective than individual unit treatments.",
  },
 
 
];

export default function PunalurFAQ() {
