    ...
    <section className="bg-[#eaf0ea] py-20 px-6">
      <div className="max-w-6xl mx-auto flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Timing card — dark */}
          <div className="bg-[#3b7cff] rounded-2xl p-8 flex flex-col gap-6 relative overflow-hidden">
            ...
            {/* Calendar icon */}
            <div className="w-10 h-10 rounded-xl bg-[#c7c7c7] flex items-center justify-center shrink-0">
            ...
            {/* Expert advice row */}
            <div className="border-t border-white pt-5 flex gap-3 items-start">
              <div className="w-7 h-7 rounded-lg bg-[#c7c7c7] flex items-center justify-center shrink-0 mt-0.5">
                <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4 text-black" stroke="currentColor" strokeWidth={1.8}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.601a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 0 3 2.48Z" />
                </svg>
              </div>
              <div>
                <p className="text-white text-[11px] font-bold tracking-wide uppercase mb-1">
                  Expert Advice
                </p>
          ...
          <div className="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm flex flex-col gap-6">
            <h3 className="text-black text-xl font-extrabold">Prevention Checklist</h3>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm px-8 py-6 flex gap-6 items-start">
          <div className="w-14 h-14 rounded-xl bg-[#c7c7c7] flex items-center justify-center shrink-0">
