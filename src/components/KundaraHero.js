...
export default function KundaraHero() {
  const [open, setOpen] = useState(false);

  return (
    <>
      <section className="bg-[#f3f4f3] py-20 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <h1 className="text-4xl lg:text-5xl font-extrabold text-black leading-tight tracking-tight">
              Pest Control<br />Kundara
            </h1>

            {/* Body */}
            <p className="text-slate-600 text-[15px] leading-relaxed">
            Kundara is a town and municipality in Kollam district, situated on the Kallada River and historically significant as a commercial and administrative centre. The town is known for its traditional industries and as a gateway to the interior districts of Kerala. Kundara’s riverine location, inland laterite soil, and mix of older established properties with newer residential development creates a pest environment that requires both structural treatment and ongoing maintenance. Kerala Pest Solutions provides professional pest management across Kundara and the surrounding areas of Kollam district, with the same IPM standards, CIB&RC-registered formulations, and written service documentation that we apply across all our operations.
            </p>
