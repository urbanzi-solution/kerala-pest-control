...
Kerala Pest Solutions provides professional pest management across Kundara and the surrounding areas of Kollam district, with the same IPM standards, CIB&RC-registered formulations, and written service documentation that we apply across all our operations.
          ...
          <div className="flex flex-wrap items-center gap-5 mt-2">
            <button className="flex items-center gap-2 bg-[#336cdf] hover:bg-[#3b7cff] text-white font-bold text-[14px] px-7 py-4 rounded-xl transition-colors duration-200">
