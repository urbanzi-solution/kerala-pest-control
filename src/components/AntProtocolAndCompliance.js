const checklist = [
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4 text-emerald-700 shrink-0 mt-0.5" stroke="currentColor" strokeWidth={1.8}>
    ...
    <div>
      ...
      <section className="bg-[#d7d9d7] py-20 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div>
              <h3 className="text-xl font-extrabold text-emerald-900 mb-3">
                Food Business Compliance
              </h3>
            ...
            <div>
              <h3 className="text-[15px] font-extrabold text-emerald-900 mb-4">
                Home Prevention Tips
              </h3>
      ...
      <section className="bg-[#f0f2f0] pb-10 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="bg-emerald-900 rounded-2xl px-8 py-8 flex gap-6 items-start">
            <div className="w-14 h-14 rounded-2xl bg-emerald-800 flex items-center justify-center shrink-0">
