export default function KarunagapallyChallenges() {
  return (
        ...
        <div className="flex flex-col gap-6">
          <div>
            <h2 className="text-2xl lg:text-3xl font-extrabold text-emerald-900 mb-3">
              Pest Challenges Specific to Karunagapally
            </h2>
            <div className="w-10 h-1 bg-amber-800 rounded-full" />
          </div>

          <p className="text-slate-600 text-[14px] leading-relaxed">
          Karunagappally’s coastal and backwater location creates one of the highest mosquito breeding pressure environments in Kollam district. The town’s cashew processing factories and associated food waste generate significant rodent pressure that affects residential areas adjacent to the industrial zones. The high humidity characteristic of coastal Kerala accelerates termite activity in the town’s substantial stock of older residential construction.
          </p>
        </div>
