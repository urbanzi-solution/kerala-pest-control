    ...
    <section className="bg-[#f0f1f0] py-20 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Badge */}
          <span className="inline-flex items-center gap-2 self-start bg-blue-100  text-blue-700 text-[10px] font-bold tracking-[0.2em] uppercase px-4 py-2 rounded-full">
            ...
            Karyavattom Specialty
          </span>

          {/* Heading */}
          <h1 className="text-4xl lg:text-5xl font-extrabold text-black leading-tight tracking-tight">
            Pest Control<br />Karyavattom
          </h1>

          {/* Body */}
          <p className="text-slate-600 text-[15px] leading-relaxed">
           Karyavattom is defined by the presence of the University of Kerala’s main campus, one of the most significant academic institutions in southern India. The surrounding neighbourhood has developed around this anchor, with student hostels, faculty residences, and a dense layer of supporting commercial activity — food stalls, tea shops, budget restaurants — shaping its character. The specific combination of institutional buildings, high-turnover student accommodation, and large-scale food service creates pest management challenges that require experience with this type of environment.
