...
export default function HotelsAndPrevention() {
  return (
    <div>
      ...
      {/* ── Hotels & PG Section ── */}
      <section className="bg-[#252525] rounded-2xl mx-4 lg:mx-10 my-6 overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-3 min-h-[420px]">
          ...
          <div className="lg:col-span-2 p-10 lg:p-12 flex flex-col justify-between gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
              {hotelFeatures.map((f) => (
                <div key={f.title} className="flex gap-3 items-start">
                  <div className="mt-0.5 shrink-0 w-7 h-7 rounded-lg bg-[#b6b6b7] flex items-center justify-center">
                    {f.icon}
                  </div>
                  <div>
            ...
            <div>
              <button className="bg-[#3b7cff] hover:bg-[#3671e6] text-white font-bold text-[13px] px-6 py-3.5 rounded-xl transition-colors duration-200">
      ...
      <section className="bg-[#f1f1f1] py-20 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            <h2 className="text-3xl lg:text-4xl font-extrabold text-black leading-tight mb-5">
              Prevention After Treatment
            </h2>
            ...
            <ul className="flex flex-col gap-4">
              {checklist.map((item, i) => (
                <li key={i} className="flex items-start gap-3">
                  <span className="mt-0.5 shrink-0 w-5 h-5 rounded-full bg-[#3b7cff] flex items-center justify-center">
