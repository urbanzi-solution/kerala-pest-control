...
export default function KazhakootamHero() {
  return (
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <span className="inline-flex items-center gap-2 self-start bg-blue-100 border  text-blue-700 text-[10px] font-bold tracking-[0.2em] uppercase px-4 py-2 rounded-full">
            ...
            Kazhakootam Specialty
          </span>

          {/* Heading */}
          <h1 className="text-4xl lg:text-5xl font-extrabold text-black leading-tight tracking-tight">
            Pest Control<br />Kazhakootam
          </h1>

          {/* Body */}
          <p className="text-slate-600 text-[15px] leading-relaxed">
          Kazhakootam is one of the fastest-growing urban corridors in Trivandrum, driven by the expansion of Technopark Phase II and III and a wave of residential apartment construction that has transformed this semi-rural area into one of the city’s most densely populated zones. The pace of development and the high concentration of multi-storey apartment buildings create persistent, evolving pest challenges.
Kerala Pest Solutions is based in Trivandrum and provides professional pest management across Kazhakootam and its surrounding areas. Our technicians are familiar with the specific construction patterns, drainage infrastructure, and seasonal pest pressures in this part of the city.

          </p>

          {/* CTA + social proof */}
          <div className="flex flex-wrap items-center gap-5 mt-2">
            <button className="flex items-center gap-2 bg-[#3b7cff] hover:bg-[#316bdd] text-white font-bold text-[14px] px-7 py-4 rounded-xl transition-colors duration-200">
