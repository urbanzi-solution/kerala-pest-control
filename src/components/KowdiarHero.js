...
export default function KowdiarHero() {
  return (
    <section className="bg-[#eef1f0] py-20 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold text-black leading-tight tracking-tight">
            Pest Control<br />Kowdiar
          </h1>

          {/* Body */}
          <p className="text-slate-600 text-[15px] leading-relaxed">
        
Kowdiar is one of Trivandrum’s most prestigious residential addresses, characterised by large independent homes, spacious garden plots, heritage construction, and a population that includes senior government officials, professional families, and long-established Trivandrum households. The area’s large properties, mature gardens, and older construction create a pest environment dominated by structural threats and the higher pest pressure that comes with extensive green cover.
Kerala Pest Solutions is based in Trivandrum and provides professional pest management across Kowdiar and its surrounding areas. Our technicians are familiar with the specific construction patterns, drainage infrastructure, and seasonal pest pressures in this part of the city.
          ...
          <div className="flex flex-wrap items-center gap-5 mt-2">
            <button className="flex items-center gap-2 bg-[#3b7cff] hover:bg-[#3975eb] text-white font-bold text-[14px] px-7 py-4 rounded-xl transition-colors duration-200">
