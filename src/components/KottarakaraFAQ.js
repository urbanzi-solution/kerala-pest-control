...
const faqs = [
  {
    question: "Do you offer same-day pest control in Kottarakkara?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. We serve individual flat owners and building management committees in Kottarakkara. Building-wide contracts for mosquito and rodent management are available and more effective than individual unit treatments.",
  },
 
 
];

export default function KottarakaraFAQ() {
    ...
    <section className="bg-white py-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <h2 className="text-3xl lg:text-4xl font-extrabold text-black text-center mb-12">
          Frequently Asked Questions — Pest Control in Kottarakara
        </h2>
