export default function KundaraManagement() {
  return (
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-7">
          <h2 className="text-2xl lg:text-3xl font-extrabold text-black leading-tight">
            Why Kundara Properties<br/>Need Regular Management
          </h2>

          <p className="text-black text-[14px] leading-relaxed">
Kollam’s tropical climate means pest pressure in Kundara is year-round, not seasonal. One-time treatment provides temporary relief; a structured maintenance programme provides consistent, lasting protection.
