        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="bg-white rounded-2xl p-6 lg:p-7 border border-slate-100 shadow-sm flex flex-col gap-5 min-h-[200px] lg:min-h-[240px]">
              ...
              <div>
                <h3 className="text-[16px] font-extrabold text-emerald-900 mb-2">Cockroaches</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm flex flex-col gap-4">
                ...
                <div>
                  <h3 className="text-[14px] font-extrabold text-emerald-900 mb-1.5">Flies</h3>
              ...
              <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm flex flex-col gap-4">
                ...
                <div>
                  <h3 className="text-[14px] font-extrabold text-emerald-900 mb-1.5">Ants</h3>
                  <p className="text-slate-400 text-[12px] leading-relaxed">
