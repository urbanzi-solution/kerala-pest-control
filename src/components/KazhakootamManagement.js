export default function KazhakootamManagement() {
  return (
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-7">
          <h2 className="text-2xl lg:text-3xl font-extrabold text-black leading-tight">
            Why Kazhakootam Properties<br/>Need Regular Management
          </h2>

          <p className="text-black text-[14px] leading-relaxed">
            Trivandrum’s tropical climate means pest pressure in Kazhakootam is year-round, not seasonal. One-time treatment provides temporary relief; a structured maintenance programme provides consistent, lasting protection.
Kerala Pest Solutions offers one-time treatments for immediate problems and quarterly Annual Maintenance Contracts (AMC) for ongoing protection. AMC clients receive priority scheduling and guaranteed retreatment at no additional cost if any activity is detected between scheduled visits.
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-[#7d7e7e] rounded-2xl p-8 flex flex-col items-center justify-center gap-5 border  min-h-[220px]">
          ...
          <div className="bg-[#a7a7a7] rounded-2xl p-8 flex flex-col items-center justify-center gap-5 min-h-[220px]">
            <div className="w-12 h-12 rounded-xl bg-[#a7a7a7] flex items-center justify-center">
              <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6 text-white" stroke="currentColor" strokeWidth={1.8}>
