...
export default function PunalurHero() {
  return (
    <section className="bg-[#eef3f1] py-20 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold text-black leading-tight tracking-tight">
            Pest Control<br />Punalur
          </h1>

          {/* Body */}
          <p className="text-slate-600 text-[15px] leading-relaxed">
        
Punalur is a town and municipality in the eastern part of Kollam district, situated on the Kallada River and serving as the commercial hub for the eastern highland areas of the district. The town sits at the boundary between Kerala’s coastal plain and the Western Ghats foothills, giving it a distinct ecological character: the surrounding forests and river create a pest environment that is materially different from Kollam’s coastal and urban areas.
Kerala Pest Solutions provides professional pest management across Punalur and the surrounding areas of Kollam district, with the same IPM standards, CIB&RC-registered formulations, and written service documentation that we apply across all our operations.
          ...
          <div className="flex flex-wrap items-center gap-5 mt-2">
            <button className="flex items-center gap-2 bg-[#3772e8] hover:bg-[#3b7cff] text-white font-bold text-[14px] px-7 py-4 rounded-xl transition-colors duration-200">
