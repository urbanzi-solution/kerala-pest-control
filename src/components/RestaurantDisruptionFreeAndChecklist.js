...
const features = [
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5 text-emerald-400 shrink-0 mt-0.5" stroke="currentColor" strokeWidth={1.8}>
              ...
              {features.map((f) => (
                <li key={f.title} className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-100/60 text-[13px] leading-relaxed">{f.description}</p>
                  </div>
                </li>
              ))}
            </ul>
      ...
      <section className="bg-[#f0f4ee] py-20 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h2 className="text-2xl lg:text-3xl font-extrabold text-emerald-900 tracking-widest uppercase mb-3">
              FSSAI Compliance Checklist
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {checklist.map((item) => (
              <div
                key={item.title}
                className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm flex gap-4 items-start hover:border-emerald-200 hover:shadow-md transition-all duration-200"
              >
                ...
                <div>
                  <p className="text-[11px] font-extrabold tracking-[0.12em] text-emerald-900 uppercase leading-snug mb-1">
                    {item.title}
                  </p>
