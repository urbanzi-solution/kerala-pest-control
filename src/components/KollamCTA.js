  ...
  return (
    <section className="bg-[#e8f0f8] py-24 px-6 text-center">
      <div className="max-w-2xl mx-auto flex flex-col items-center gap-6">
        ...
        <button className="bg-amber-800 hover:bg-amber-700 text-white font-bold text-[14px] px-10 py-4 rounded-xl transition-colors duration-200 mt-2">
        ...
        <div className="flex flex-wrap justify-center items-center gap-6 mt-2">
          {badges.map((badge) => (
            <div key={badge} className="flex items-center gap-2">
              <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4 text-emerald-600 shrink-0" stroke="currentColor" strokeWidth={2.5}>
