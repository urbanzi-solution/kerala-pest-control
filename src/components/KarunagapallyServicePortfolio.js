const services = [
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-7 h-7 text-black" stroke="currentColor" strokeWidth={1.5}>
...
const standards = [
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5 text-eblack" stroke="currentColor" strokeWidth={1.8}>
...
const areaHubs = [
 "Kottarakkara", "Paravur",
  "Chavara", "Perinad",
  "Kayamkulam",
];

export default function KarunagappallyServicePortfolio() {
  return (
    <div>
      ...
      <section className="bg-[#f0f0f0] pb-20 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-4">
            ...
            {standards.map((item) => (
              <div key={item.title} className="flex gap-4 items-start">
                <div className="w-9 h-9 rounded-xl bg-[#cccfcf] border  flex items-center justify-center shrink-0 mt-0.5">
                  {item.icon}
                </div>
                <div>
                  <p className="text-slate-800 text-[13px] font-bold mb-1">{item.title}</p>
                  <p className="text-black text-[12px] leading-relaxed">{item.description}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-7">
            ...
            <div className="flex justify-between items-start mb-5">
              ...
              <div className="w-10 h-10 rounded-xl bg-[#dbdbdb] flex items-center justify-center shrink-0">
            ...
            <div className="grid grid-cols-2 gap-3">
              {areaHubs.map((area) => (
                <div
                  key={area}
                  className="flex items-center gap-2.5 border border-slate-100 rounded-xl px-4 py-3 bg-slate-50  hover:bg-[#e2e3e5] transition-colors duration-200"
                >
                  <div className="w-1.5 h-1.5 rounded-full bg-[#3b7cff] shrink-0" />
