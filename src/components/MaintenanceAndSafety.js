    ...
    <section className="bg-[#eaf0ea] py-20 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
        ...
        <div className="bg-white rounded-2xl p-8 border border-slate-100 shadow-sm flex flex-col gap-5">
          ...
          <div className="bg-white border-2 border-emerald-800 rounded-xl p-5 flex flex-col gap-2">
            <div className="flex items-start justify-between gap-4">
              <p className="text-[14px] font-bold text-slate-800">Quarterly AMC</p>
              <div className="flex flex-col items-end gap-1 shrink-0">
                <span className="bg-emerald-800 text-white text-[8px] font-bold tracking-[0.15em] uppercase px-2.5 py-1 rounded-full">
                  Recommended
                </span>
                <span className="text-emerald-700 text-[13px] font-bold">Value+</span>
              </div>
            </div>
            <p className="text-slate-400 text-[12px] leading-relaxed">
