...
export default function KarunagapallyHero() {
  return (
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <span className="inline-flex items-center gap-2 self-start bg-blue-100 border  text-blue-700 text-[10px] font-bold tracking-[0.2em] uppercase px-4 py-2 rounded-full">
            ...
            Karunagapally Specialty
          </span>

          {/* Heading */}
          <h1 className="text-4xl lg:text-5xl font-extrabold text-black leading-tight tracking-tight">
            Pest Control<br />Karunagapally
          </h1>

          {/* Body */}
          <p className="text-slate-600 text-[15px] leading-relaxed">
        
Karunagappally is a coastal town and municipality in Kollam district, situated on the Arabian Sea coast and the Kayamkulam backwater system. It is one of the most significant cashew processing centres in Kerala, with a substantial industrial workforce and a densely populated residential area serving both the cashew industry and local agriculture. The combination of coastal location, backwater proximity, and industrial activity creates a specific pest environment.
Kerala Pest Solutions provides professional pest management across Karunagappally and the surrounding areas of Kollam district, with the same IPM standards, CIB&RC-registered formulations, and written service documentation that we apply across all our operations.
          ...
          <div className="flex flex-wrap items-center gap-5 mt-2">
            <button className="flex items-center gap-2 bg-[#346ee0] hover:bg-[#3b7cff] text-white font-bold text-[14px] px-7 py-4 rounded-xl transition-colors duration-200">
