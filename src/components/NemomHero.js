...
export default function NemomHero() {
  return (
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold text-black leading-tight tracking-tight">
            Pest Control<br />Nemom
          </h1>

          {/* Body */}
          <p className="text-slate-600 text-[15px] leading-relaxed">
        
Nemom is a southern Trivandrum locality that has undergone rapid residential development over the past decade, driven by its proximity to the National Highway bypass and the availability of land compared to the congested city centre. The area is now a mix of newer independent houses, mid-rise apartment developments, and remnants of agricultural and paddy land — a transition zone where the pest pressures of urban construction meet the higher baseline pest loads of the semi-rural environment.
Kerala Pest Solutions is based in Trivandrum and provides professional pest management across Nemom and its surrounding areas. Our technicians are familiar with the specific construction patterns, drainage infrastructure, and seasonal pest pressures in this part of the city.
          ...
          <div className="flex flex-wrap items-center gap-5 mt-2">
            <button className="flex items-center gap-2 bg-[#346ee3] hover:bg-[#3b7cff] text-white font-bold text-[14px] px-7 py-4 rounded-xl transition-colors duration-200">
