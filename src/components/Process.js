...
export default function Process() {
  return (
    <section className="bg-[#0c1a1a] text-white py-20">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="relative mt-16">
          ...
          {/* Horizontal Line */}
          <div className="hidden md:block absolute top-10 left-0 right-0 h-[2px] bg-gray-700" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative">
            {steps.map((step, i) => (
              <div key={i} className="flex flex-col items-center text-center relative">
                ...
                {/* Icon Box */}
                <div className="w-16 h-16 bg-green-700 rounded-lg flex items-center justify-center mb-6 z-10">
                  {step.icon}
                </div>
