...
Pre-construction soil barrier treatment is the most cost-effective protection for any new build in Kazhakootam. For completed properties, we provide post-construction drilling and injection treatment with an AMC covering the warranty period and monitoring for any signs of reinfestation from ongoing construction nearby.
              ...
              <button className="self-start bg-[#3b7cff] hover:bg-[#356fe3] text-white font-bold text-[13px] px-6 py-3 rounded-xl transition-colors duration-200">
                Learn More
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-7 border border-slate-100 shadow-sm flex flex-col gap-4 justify-between">
            <div>
              <div className="w-10 h-10 rounded-xl bg-[#e1e1e1] border  flex items-center justify-center mb-5 shrink-0">
...
Our programme combines larviciding of all identifiable water bodies on the property with ULV fogging for adult population knockdown, and a written source reduction report identifying permanent changes that will reduce breeding habitat. Monthly visits during the June to October monsoon period are recommended for properties in active construction zones.
            ...
            <div className="flex items-center gap-3 mt-6">
              <div className="w-8 h-8 rounded-lg bg-[#acacac] flex items-center justify-center shrink-0">
                <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4 text-black" stroke="currentColor" strokeWidth={1.8}>
          ...
          <div className="bg-white rounded-2xl p-7 border border-slate-100 shadow-sm flex flex-col gap-5">
            ...
            <ul className="flex flex-col gap-3">
              {portfolio.map((item) => (
                ...
                >
                  <div className="w-7 h-7 rounded-lg bg-[#c5c5c5] flex items-center justify-center shrink-0">
                    {item.icon}
                  </div>
