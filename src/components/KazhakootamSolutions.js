...
export default function KazhakootamSolutions() {
  return (
    <section className="bg-[#e8f0f8] py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="text-3xl lg:text-4xl font-extrabold text-emerald-900 text-center tracking-tight mb-10">
          Specialized Solutions for Kazhakkoottam
        </h2>
          ...
          <div className="lg:col-span-2 relative rounded-2xl overflow-hidden min-h-[320px] flex flex-col justify-end">
            ...
            <div className="relative z-10 p-8 flex flex-col gap-4 -mt-10">
              <h3 className="text-white text-xl font-extrabold leading-snug">
                Termite Treatment in Kazhakootam
              </h3>
              <p className="text-emerald-100/75 text-[13px] leading-relaxed max-w-md">
               Construction activity in Kazhakootam is a persistent source of termite pressure on completed properties. When new foundation works disturb the laterite soil, existing subterranean termite colonies are forced to relocate — and adjacent completed buildings are their next target. New apartment buildings in the area are at particular risk during the first three to five years after construction.
Pre-construction soil barrier treatment is the most cost-effective protection for any new build in Kazhakootam. For completed properties, we provide post-construction drilling and injection treatment with an AMC covering the warranty period and monitoring for any signs of reinfestation from ongoing construction nearby.
          ...
          <div className="bg-emerald-800 rounded-2xl p-8 flex flex-col justify-between min-h-[280px]">
            <div>
              ...
              <p className="text-emerald-100/70 text-[13px] leading-relaxed">
                The combination of active construction sites, building sumps, rooftop overhead tanks, and waterlogged excavations across Kazhakootam’s expanding residential and commercial stock creates one of the highest mosquito breeding densities in Trivandrum during the monsoon season.
Our programme combines larviciding of all identifiable water bodies on the property with ULV fogging for adult population knockdown, and a written source reduction report identifying permanent changes that will reduce breeding habitat. Monthly visits during the June to October monsoon period are recommended for properties in active construction zones.
