...
export default function KottarakaraSolutions() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
          ...
          <div className="lg:col-span-2 relative rounded-2xl overflow-hidden min-h-[320px] flex flex-col justify-end">
            ...
            <div className="relative z-10 p-8 flex flex-col gap-4 -mt-10">
              ...
              Termite Treatment in Kottarakkara
              </h3>
...
We provide structural inspections with written damage reports, post-construction soil treatment via drilling and injection, and wood treatment for exposed structural timber. For properties undergoing renovation, pre-construction soil re-treatment during the works is strongly recommended.
          ...
          <div className="bg-white rounded-2xl p-7 border border-slate-100 shadow-sm flex flex-col gap-4 justify-between">
            <div>
              ...
              <h3 className="text-slate-900 text-xl font-extrabold mb-3">Rodent Control in Kottarakkara</h3>
              <p className="text-slate-500 text-[13px] leading-relaxed">
            Kottarakkara’s food market, commercial food businesses, and the agricultural land surrounding the town provide habitat and food sources that sustain an active rodent population. Rats forage from the market area and agricultural margins into adjacent residential and commercial properties.
Our programme deploys bait stations on confirmed run pathways with fortnightly monitoring to clearance. The proofing report identifies every structural entry point and provides sealing recommendations.
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="bg-emerald-800 rounded-2xl p-8 flex flex-col justify-between min-h-[280px]">
            <div>
              <h3 className="text-white text-xl font-extrabold mb-4">Cockroach Control in Kottarakkara</h3>
              <p className="text-emerald-100/70 text-[13px] leading-relaxed">
             Kottarakkara’s commercial streets, food market, and restaurant concentration create a cockroach pressure gradient that affects residential properties in adjacent streets. The older drainage infrastructure serving the town centre provides migration pathways between commercial and residential areas.
Our gel bait treatment targets harborage sites directly, with a structural recommendation report identifying drainage gaps and pipe penetrations that are allowing re-entry. For restaurants and food businesses, we provide FSSAI-compliant documentation.
