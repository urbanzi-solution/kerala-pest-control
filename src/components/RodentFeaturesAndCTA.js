...
const features = [
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6 text-[#3b7cff]" stroke="currentColor" strokeWidth={1.8}>
    ...
    <div>
      ...
      <section className="bg-gray-300 pb-16 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="bg-[#ffffff] rounded-2xl px-10 py-12 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">

            {/* Text */}
            <div className="max-w-xl">
              <p className="text-black text-2xl lg:text-3xl font-extrabold italic leading-snug mb-4">
