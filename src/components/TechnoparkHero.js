        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-slate-600 text-[15px] leading-relaxed">
             Technopark is one of Asia’s largest IT parks, housing hundreds of technology companies across three phases and employing tens of thousands of professionals. The surrounding residential belt — populated by IT workers, many from outside Kerala — is characterised by a high density of PG accommodations, serviced apartments, and rented flats with significant occupant turnover. This creates pest management challenges that are distinctly different from those of a standard residential neighbourhood. Kerala Pest Solutions is based in Trivandrum and provides professional pest management across Technopark and its surrounding areas.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-5 mt-2">
              ...
              <button
                ...
                className="flex items-center gap-2 bg-[#3b7cff] hover:bg-[#3771e5] text-white font-bold text-[14px] px-7 py-4 rounded-xl transition-colors duration-200"
              >
