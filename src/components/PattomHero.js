...
export default function PattomHero() {
  return (
    <section className="bg-[#eaeaea] py-20 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <h1 className="text-4xl lg:text-5xl font-extrabold text-black leading-tight tracking-tight">
            Pest Control<br />Pattom
          </h1>

          {/* Body */}
          <p className="text-slate-600 text-[15px] leading-relaxed">
        
Pattom is one of Trivandrum’s most established and sought-after residential areas, characterised by older independent bungalows, government residential colonies, and a mix of newer apartment developments. The area’s mature trees, older drainage infrastructure, and significant proportion of heritage-style timber construction create a pest profile dominated by structural threats — particularly termites — and the persistent pressures of a dense, long-established urban neighbourhood.
Kerala Pest Solutions is based in Trivandrum and provides professional pest management across Pattom and its surrounding areas. Our technicians are familiar with the specific construction patterns, drainage infrastructure, and seasonal pest pressures in this part of the city.
          ...
          <div className="flex flex-wrap items-center gap-5 mt-2">
            <button className="flex items-center gap-2 bg-[#3b7cff] hover:bg-[#3773ea] text-white font-bold text-[14px] px-7 py-4 rounded-xl transition-colors duration-200">
