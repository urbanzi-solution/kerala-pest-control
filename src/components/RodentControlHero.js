    ...
    <section className="bg-[#f0f2f3] py-20 px-6 min-h-[560px] flex items-center">
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* Badge */}
          <span className="inline-flex items-center self-start border border-black text-black text-[10px] font-semibold tracking-[0.22em] uppercase px-4 py-2 rounded-full">
          ...
          <p className="text-black text-[14px] leading-relaxed">
            ...
            <strong className="text-black font-bold">Trivandrum</strong> and{" "}
            <strong className="text-black font-bold">Kollam</strong>. Tamper-resistant stations,
