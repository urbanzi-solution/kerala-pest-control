const areas = [
  ...
  ["pallipuram", "Kazhakkoottam", "karyavattom"],
];

export default function TechnoparkCoverage() {
  return (
    <section className="bg-[#ededed] py-14 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">

        {/* Left */}
        <div className="flex flex-col gap-4">
          <h2 className="text-2xl lg:text-3xl font-extrabold text-black leading-tight">
            Comprehensive Coverage Across<br/>the technopark Corridor
          </h2>
          <p className="text-slate-500 text-[14px] leading-relaxed max-w-md">
           Kerala Pest Solutions provides professional, government-approved pest management across Technopark, Trivandrum. 
          </p>
        </div>
