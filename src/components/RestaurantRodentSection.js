    ...
    <div>
      ...
      <section className="bg-[#eaf0ea] pb-20 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="bg-emerald-900 rounded-2xl p-8 flex flex-col gap-7">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-lg font-extrabold text-white">Safety Protocols</h3>
            </div>

            <div className="flex flex-col gap-6">
              <div>
                <p className="text-[10px] font-bold tracking-[0.2em] text-emerald-400 uppercase mb-2">
                  Tamper-Resistance
                </p>
            ...
            {/* Safety warning */}
            <div className="bg-emerald-800/60 rounded-xl p-4 border border-emerald-700/40 mt-auto">
              <p className="text-emerald-200/70 text-[11px] leading-relaxed italic">
                <strong className="not-italic text-emerald-200">Safety Warning:</strong> In case of
